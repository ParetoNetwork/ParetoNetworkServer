            ...
            <b-form-radio-group v-model="selectedPath">
                ...
                <div class="btn-group offset-md-1 ml-md-4 col-md-8 dropdown-row custom-group">
                  ...
                  <div class="address-controls">
                    <div :class="{ 'address-disabled': !paths[0].selected.address }">
                      ...
                      <a v-if="!!paths[0].selected.address"
                         v-bind:href="etherscan+'/address/'+paths[0].selected.address" target="_blank">
                  ...
                  <div class="address-controls">
                    <div :class="{ 'address-disabled': !paths[1].selected.address }">
                      ...
                      <i id="copyAddressStandard"
                         ...
                         class="fa fa-copy cursor-pointer"></i>
                      <a v-if="!!paths[1].selected.address"
                         v-bind:href="etherscan+'/address/'+paths[1].selected.address" target="_blank">
                        <i class="fa fa-external-link-alt"></i>
                      </a>
                      <i v-else class="fa fa-external-link-alt"></i>
                    </div>
              ...
              <b-row class="m-2 mt-4">
                  ...
                  <div class="address-controls">
                    <div :class="{ 'address-disabled': !paths[2].selected.address }">
                      ...
                      <i id="copyAddressCustom"
                         ...
                         class="fa fa-copy cursor-pointer"></i>
                      <a v-if="!!paths[2].selected.address"
                         v-bind:href="etherscan+'/address/'+paths[2].selected.address" target="_blank">
                        <i class="fa fa-external-link-alt"></i>
                      </a>
                      <i v-else class="fa fa-external-link-alt"></i>
                    </div>
                ...
                <div class="col-12">
                  ...
                  <i v-if="loadingCustomPath || (!paths[0].address && supported) || loadingInfiniteScrollData || loadingSign"
                     class="fa fa-spinner fa-spin ml-2"></i>
                </div>
              </b-row>
            </b-form-radio-group>
          </b-form-group>
