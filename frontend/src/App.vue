...
<script>
    ...
    export default {
        ...
        metaInfo: {
            ...
            meta: [
                { name: "description", content: 'The Pareto Network is a platform providing current, reputable & actionable intel for traders and investors. It is an event driven, alternative data source for capturing alpha.' },
